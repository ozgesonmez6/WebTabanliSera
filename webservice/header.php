...
<head>
	...
	<title>Tarım İzleme Otomasyonu</title>
...
<div id="wrapper">
	...
	<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
		...
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="dashboard.php">Tarım İzleme Otomasyonu</a>
		</div>
		<!-- Top Menu Items -->
		...
		<div class="collapse navbar-collapse navbar-ex1-collapse">
			<ul class="nav navbar-nav side-nav">
				<li <?php if ($page == 'dashboard') echo 'class="active"'; ?>>
					<a href="dashboard.php"><i class="fa fa-fw fa-dashboard"></i> Pano</a>
				</li>
				<li <?php if ($page == 'stats') echo 'class="active"'; ?>>
					<a href="stats.php"><i class="fa fa-fw fa-bar-chart-o"></i> İstatistikler</a>
				</li>
			</ul>
		</div>
		<!-- /.navbar-collapse -->
